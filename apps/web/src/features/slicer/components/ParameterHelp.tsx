...
function Diagram({ type }: { type: HelpDiagram }) {
  ...
  return (
    <svg className="parameter-help-diagram" viewBox="0 0 120 54" aria-hidden="true">
      ...
      {type === 'brim' && <><path {...common} d="M18 44h84M39 36h42l-7-22H46z" /><path {...common} d="M31 39h58M25 34h12m46 0h12" /></>}
      {type === 'skirt' && <><path {...common} d="M18 44h84M43 36h34l-6-20H49z" /><rect {...common} x="28" y="9" width="64" height="32" rx="12" strokeDasharray="4 3" /></>}
